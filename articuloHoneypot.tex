...
\begin{document}
	...
	\titlerunning{Cybersecurity in Scientific Network Infrastructures by Honeypots}
...
\begin{figure}[h]
	\centering{\includegraphics[width=5cm,height=6cm,keepaspectratio]{dionaeaInternalExternal.png}}
	\label{fig:intvsextDionaea}
	\centering{\includegraphics[width=5cm,height=6cm,keepaspectratio]{kippoInternalExternal.png}}
...
\begin{figure}[h]
	\centering{\includegraphics[width=4cm,height=5cm,keepaspectratio]{subset1.png}}
	\label{fig:intvsextDionaea}
	\centering{\includegraphics[width=4cm,height=5cm,keepaspectratio]{subset2.png}}
	\label{fig:intvsextKippo}
