...
privacy in the use of IT infrastructures. Scientist networks have a
% What should be a balance? Wouldn't that be "There should be a
% balance" or "IT infrastructures in universities and other research
% centers should strike a balance between... - JJ"
high risk of attack as a source of valuable information and resources
because they were designed with an open and decentralized philosophy,
in favour of the transmission of knowledge when security wasn't a
critical section\cite{iris-proyecto}.  
%No se ponen citas en el abstract - JJ
%¿Sólo las universidades? ¿Por qué las universidades? - JJ
%Porque en la concepción de sus redes se fomentó más el principio de
%facilitar el acceso a la información frente a su protección - JL
% Deberías hablar de las universidades en el título. NO IT-scientist - JJ
%FERGU: Scientist networks->Scientific networks. Por otro lado empieza una frase categórica y de repente salto a lo de las redes. Pondría algo más literario, por ejemplo "When dealing with security concerns in the use of IT infraestructures a good balance between security concerns and the right to privacy should be mantained. This is very important in scientific networks, because they were created as... and they have..."
%No uses contracciones en un paper "wasn't"->"was not"
%Tampoco referencias en los abstracts, quita el iris-proyecto. Las leyes de los papers.
%Bueno, y aunque no está mal del todo, en papers en inglés deberías citar papers en inglés. Busca una referencia equivalente a la que usas, pero en inglés, que queda más fino.
Private and scientific information have a enormous value for an attacker but the end user is worried about his privacy too. %Par de
             ...
             %tened cuidado- JJ
             %FERGU: esto es repetir lo de arriba. Lo quitaría o lo pondría  más literario :) como antes : "Although private and sc. information have a great value for attackers, the end user privacy is an important ...blablabla"
...
intrusive techniques like the direct analysis of the traffic through
networking devices. Also we expose the difficulties found in the
information's analysis gathered. Finally we propose the application of
machine learning to overcome them in future works. 
 % ¿Y cuál es el objetivo? ¿Caso de éxito? ¿Caso de fracaso? ¿Hay algo
 % original en la implementación de los honeypots? - JJ 
%El objetivo es mostrar que son como medios de detección muy efectivos
%sin necesidad de ser intrusivos en el trafico de red, pero que
%requieren de machine learning para solventar algunas deficiencias en
%cuanto a la deteccion de amenazas avanzadas se refiere. Exito
%https://www.honeynet.org/about,
%https://es.scribd.com/doc/174841947/Memoria, y "llamare" a los
%argentinos a ver si tienen algo publicado de como les va con su
%sistema - JL
% Future work no va en el abstract. SE cuenta qué se va a hacer - JJ

%FERGU: La primera frase "its defence plan". El plan de defensa de quien? Ponerlo más claro: Ejemplo: A good strategy to achieve this balance between security and privacy is the use of honeypots, as the can be the cornerstone of the defence plan of research agencies. In this paper, we present... Also, we expose (para no repetir expose)
%like -> such as (esto me pasaba a mí también xD)
...
the number of attacks increases continuously\cite{esset-tendencias,cni-ccn-tendencias-2014}. Scientist networks are a special and interesting case, % cita - JJ
%Corregido
%FERGU: para usar dos citas seguidas pon mejor \cite{esset-tendencias,cni-ccn-tendencias-2014}
...
%FERGU: estoy con JJ, el concepto cyberespacio fuera de los 90 ya no mola tanto xDDD Tampoco mola mucho esta sección (y aparte, como dice JJ no puede haber subsecciones en la introducción de un paper)
...
%FERGU: este parrafo si está guay escrito
