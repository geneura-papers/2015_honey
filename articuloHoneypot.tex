...
The attempts of malware propagation usually belong to advanced and persistent threats and come accompanied by a multivector attack %cite.
When a Windows host belonging to the infrastructure was compromised for a USB key, after had communicated its incorporation to the command and control server of the netbot, it started to scan its neighbors in the subnet. Then it established connections with the sensors that  emulated the ms08-067 %cite
