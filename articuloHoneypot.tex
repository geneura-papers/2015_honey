...
\and Gustavo Romero López} %and JJ? - JJ
...
and which have  most hosts  behind the DMZ\footnote{Demilitarized
  Zone.} %citaaaaaa!!!- JJ
, the scientist networks were born with a open % WITH A OPEN!!!!
                                % Triple #fail inglés - JJ
...
computer and human resources is a juicy target for hostile agents. % ¿en serio? ¿En la UGR? ¿Ese es el objetivo o lo es poner bitminers? - JJ
Also, the big size of the DMZ %citaaaaa! - JJ
