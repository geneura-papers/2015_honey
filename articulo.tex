...
% Mejor Enhancing cybersecurity using Machine Learning Techniques: smart fight against advanced threats - JJ
% Además, ¿qué es? ¿Un review? ¿Vas a tratar sólo de APTs? ¿Vas a
% hacer alguna comparación empírica? El título debe transmitir
% claramente el objetivo del artículo - JJ

\titlerunning{The Improvement of Cybersecurity by Machine Learning}

\author{Juan Luis Martin Acal\inst{1} \and Pedro A. Castillo Valdivieso\inst{1}
\and Gustavo Romero López}

\authorrunning{Juan Luis Martin Acal et al.}
...
\begin{abstract}
Always advance threats has been the biggest risk for the network
infrastructure security.  %Cuidadín con el inglés.  Esta frase no se
                          %entiende, y es la primera del abstract.
